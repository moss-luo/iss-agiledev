package com.isoftstone.agiledev.osgi.basedata.service;
...
@Service(name="4")
public class BasedataMenuService implements TreeDataProvider{
	...
	public List<TreeSupport> getNodes(String parentId) {
		if(parentId.equals("0"))
			return dao.list("com.isoftstone.agiledev.osgi.basedata.domain.BasedataMenuMapper.queryRootMenu", null);
		return dao.list("com.isoftstone.agiledev.osgi.basedata.domain.BasedataMenuMapper.queryMenu", parentId);
	}
}
